	...
	*/
	...
	partType = "outer"; // inner

    frameSize = [10,10,10];
    
    innerBearingRadius = 4;
    
    innerHolderHeight = 10;

	module ball_bearing_mount(){
		if(partType == "outer"){

        } else if(partType == "inner"){
            cuboid(frameSize);
            cuboid(r=innerBearingRadius, h=innerHolderHeight);
        } else {
